...
.i18n {
  ...
  &[data-key="lang"]::after { content: var(--lang); }
  &[data-key="common-theme"]::after { content: var(--common-theme); }
  &[data-key="home-screen-theme"]::after { content: var(--home-screen-theme); }
  &[data-key="ru"]::after { content: var(--ru); }
  &[data-key="en"]::after { content: var(--en); }
  &[data-key="dark"]::after { content: var(--dark); }
  &[data-key="light"]::after { content: var(--light); }
  &[data-key="green"]::after { content: var(--green); }
  &[data-key="pink"]::after { content: var(--pink); }
  &[data-key="blue"]::after { content: var(--blue); }
  &[data-key="yellow"]::after { content: var(--yellow); }
