  ...
  <wrapper_main>
    ...
    <main>
      <div class="set">
        ...
        <div class="options">
          <button
            @click="saveConfig('lang', 'ru')"
            class="i18n"
            data-key="ru"
          ></button>
          <button
            @click="saveConfig('lang', 'en')"
            class="i18n"
            data-key="en"
          ></button>
        </div>
      ...
      <div class="set">
        ...
        <div class="options">
          <button
            @click="saveConfig('theme', 'dark')"
            class="i18n"
            data-key="dark"
          ></button>
          <button
            @click="saveConfig('theme', 'light')"
            class="i18n"
            data-key="light"
          ></button>
        </div>
      ...
      <div class="set">
        ...
        <div class="options">
          <button
            @click="saveConfig('homeTheme', 'green')"
            class="i18n"
            data-key="green"
          ></button>
          <button
            @click="saveConfig('homeTheme', 'pink')"
            class="i18n"
            data-key="pink"
          ></button>
          <button
            @click="saveConfig('homeTheme', 'blue')"
            class="i18n"
            data-key="blue"
          ></button>
          <button
            @click="saveConfig('homeTheme', 'yellow')"
            class="i18n"
            data-key="yellow"
          ></button>
        </div>
