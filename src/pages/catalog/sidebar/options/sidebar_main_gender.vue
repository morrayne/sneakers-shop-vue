...
<template>
  <div class="filter-holder">
    ...
    <sidebar_item v-for="item in props.data_array" :key="item" :name="item" :val="item" :display_color="false" :color="'#000'" :direction="false" :active="activeGender === item" @was-clicked="() => filterState.methods.setFilter('gender', item)" />
  </div>
</template>
